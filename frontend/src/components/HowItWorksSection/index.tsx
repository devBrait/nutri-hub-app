      ...
      >
        ...
        <Box
          sx={{
            ...
            height: '2px',
            zIndex: 0,
            background: 'repeating-linear-gradient(90deg, rgba(62,123,91,0.35) 0px, rgba(62,123,91,0.35) 8px, transparent 8px, transparent 18px)',
          }}
        />
        ...
        {STEPS.map(({ step, Icon, title, desc }, i) => (
          ...
          >
            ...
            <Typography
              sx={{ fontFamily: '"DM Sans", sans-serif', fontWeight: 700, fontSize: '1rem', color: '#12211A', mb: 0.75 }}
            >
              {title}
            </Typography>
            <Typography
