...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between', px: { xs: 2.5, md: 5 }, py: 1.25 }}>
          {/* Logotipo */}
          <Typography
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 1.5, alignItems: 'center' }}>
            <Button
              sx={{
                ...
                '&:hover': { bgcolor: '#c0dcd5', transform: 'translateY(-1px)' },
              }}
            >
              Entrar
            </Button>
      ...
      >
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
          ...
          <IconButton onClick={() => setDrawerOpen(false)} sx={{ color: '#3E7B5B' }}>
            <CloseIcon />
          </IconButton>
        </Box>
