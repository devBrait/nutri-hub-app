...
export default function Register() {
	...
	return (
		<AuthLayout>
				...
				endAdornment={
					<InputAdornment position="end">
						<IconButton
							...
							edge="end"
							size="small"
							sx={{ color: theme.palette.typography.secondaryCardText, mr: 0.5 }}
						>
			...
			>
				<MenuItem value="PACIENTE" sx={{ fontFamily: '"DM Sans", sans-serif', fontSize: "0.92rem" }}>
					Paciente
				</MenuItem>
				<MenuItem value="NUTRICIONISTA" sx={{ fontFamily: '"DM Sans", sans-serif', fontSize: "0.92rem" }}>
					Nutricionista
				</MenuItem>
			</Select>
			...
			<Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 2.5 }}>
				<Divider sx={{ flex: 1, borderColor: alpha(theme.palette.typography.mainText, 0.1) }} />
				<Typography sx={{ fontFamily: '"DM Sans", sans-serif', fontSize: "0.78rem", color: theme.palette.typography.secondaryCardText }}>
					ou
				</Typography>
				<Divider sx={{ flex: 1, borderColor: alpha(theme.palette.typography.mainText, 0.1) }} />
			</Box>
