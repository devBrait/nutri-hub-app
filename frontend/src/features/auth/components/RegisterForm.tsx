...
export default function RegisterForm() {
		...
		try {
			...
			if (response.success) {
				...
				try {
					...
					enqueueSnackbar("Erro ao configurar o perfil. Tente criar sua conta novamente.", {
						variant: "error",
					});
				...
				const destination =
					response.role === "Nutritionist" ? "/nutritionist/dashboard" : "/onboarding";
	...
	return (
		<AuthLayout>
			...
			>
				{loading ? <CircularProgress size={22} sx={{ color: "#fff" }} /> : "Continuar →"}
			</Button>
