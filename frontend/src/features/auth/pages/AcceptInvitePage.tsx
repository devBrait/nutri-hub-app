  ...
  return (
    ...
    >
      ...
      >
        ...
        {done ? (
          <>
            <Typography sx={{ fontSize: "1.2rem", fontWeight: 700, color: theme.palette.typography.mainText, mb: 1 }}>
              Vínculo criado!
            </Typography>
            <Typography sx={{ fontSize: "0.88rem", color: theme.palette.typography.secondaryText, mb: 3 }}>
          ...
          <>
            ...
            <Button
              ...
              sx={{ borderRadius: "12px", py: 1.5, fontWeight: 600, textTransform: "none", borderColor: theme.palette.divider }}
            >
              Criar conta
            </Button>
          </>
          ...
          <>
            ...
            <Typography sx={{ fontSize: "0.88rem", color: theme.palette.typography.secondaryText, mb: 3 }}>
              Você foi convidado para se vincular a um nutricionista no NutriHub. Aceite para começar o acompanhamento.
            </Typography>
            <Button
              fullWidth
              disabled={loading}
