      ...
      <SectionCard>
        {loading ? (
          ...
          <Box sx={{ textAlign: "center", py: 6 }}>
            ...
            <Typography sx={{ fontSize: "0.88rem", color: theme.palette.typography.secondaryCardText }}>
              Nenhum paciente vinculado ainda.
            </Typography>
            <Typography sx={{ fontSize: "0.78rem", color: theme.palette.typography.secondaryCardText, mt: 0.5 }}>
          ...
          patients.map((p) => (
            ...
            >
              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                ...
                <Typography sx={{ fontSize: "0.74rem", color: theme.palette.typography.secondaryCardText }}>
                  {p.email}
                </Typography>
              </Box>
