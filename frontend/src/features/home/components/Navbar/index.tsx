		...
		<>
			...
			>
				...
				>
					...
					/>
					<IconButton onClick={() => setDrawerOpen(false)} sx={{ color: theme.palette.brand.main }}>
						<CloseIcon />
					</IconButton>
				</Box>

				<Divider sx={{ borderColor: alpha(theme.palette.brand.main, 0.12), mb: 3 }} />
				...
				<Divider sx={{ borderColor: alpha(theme.palette.brand.main, 0.12), my: 3 }} />
